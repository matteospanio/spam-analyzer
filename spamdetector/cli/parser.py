...
def add_args(parser: ArgumentParser, config: dict) -> None:
    ...
    parser.add_argument('-o', '--output-file', help='Write output to a file (works only for json format)', type=FileType('w'), metavar='FILE', dest='output_file')
    parser.add_argument('--destination-dir', help='The directory where copy your classified emails', metavar='DIRECTORY', default=None)
